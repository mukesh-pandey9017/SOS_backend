...
from SOS.settings import BASE_DIR


class EmailBuilder:
    # template_dir = BASE_DIR +'/'+'service/template/'
    # print("CONCRETING_OPRATOR",template_dir)
    ...
    def sign_up(params):
        ...
        msg += "<P><a href='http://www.sunrays.co.in' >-SUNRAYS Technologies</a></P>"
        msg += "</BODY></HTML>"
    ...
    def forgot_password(params):
        ...
        print("---------params.firstName----->", params.firstName)
        msg = ""
        msg += "<HTML><BODY>"
